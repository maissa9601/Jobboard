...
class CloudflareBypasser:
    ...
    #Cherche un iframe dans un arbre de Shadow DOM imbriqué
    ...
    #Cherche un input dans un arbre de Shadow DOM imbriqué
        ...
        if ele.shadow_root:
            ...
            for child in ele.children():
                ...
                if result:
                    return result
        return None
    #Localisation du bouton de vérification
    def locate_cf_button(self):
        ...
        if button:
            ...
            # si le button n'existe pas recherhcer récursivement
    ...
    def is_bypassed(self):
        try:
            ...
            return False
    #Tentative automatique de bypass
    def bypass(self):
